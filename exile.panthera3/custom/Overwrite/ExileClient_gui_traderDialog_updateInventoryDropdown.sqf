...
_nearVehicles = nearestObjects [player, ["LandVehicle", "Air", "Ship", "CargoNet_01_box_F","Exile_Container_SupplyBox","I_CargoNet_01_ammo_F","O_CargoNet_01_ammo_F","B_CargoNet_01_ammo_F","I_supplyCrate_F","Box_NATO_AmmoVeh_F","Box_East_AmmoVeh_F","B_supplyCrate_F","I_CargoNET_01_F","Box_NATO_Wps_F"], 80];
{
    if (local _x) then
    {
        if (alive _x) then
