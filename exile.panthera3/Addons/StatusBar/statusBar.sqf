...
//	systemChat format["StatusBar Initialized", _rscLayer];
	...
	while {true} do 
	{
		...
		_wallet =  (player getVariable ["ExileMoney", 0] call BIS_fnc_NumberText);
		_lockers = (player getVariable ["ExileLocker", 0] call BIS_fnc_NumberText);	
		...
		switch(_minutes) do
	{
		...
		((uiNamespace getVariable "osefStatusBarAdmin")displayCtrl 55554)ctrlSetStructuredText parseText 
			...
			<t shadow='1' shadowColor='#000000' color='%15'><img size='1.0'  shadowColor='#000000' image='addons\statusbar\icons\body.paa' color='%10'/> %21</t>"
			/*<t shadow='1' shadowColor='#000000' color='%15'><img size='1.0'  shadowColor='#000000' image='addons\statusbar\icons\temp.paa' color='%10'/> %22</t>"*/,				
					"%",                       //1
