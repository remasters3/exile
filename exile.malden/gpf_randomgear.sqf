...
if (_killmsg) Then {_unit addMPEventHandler ["MPKilled",'_killed = _this Select 0; _killer = _this Select 1;systemchat Format ["%1 killed %2",_killed,_killer];[_killed,_killer]execVM "gpf_fn_killmsg.sqf";'];};
