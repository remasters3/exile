...
private _target = SelectRandom [[8013.65,9687.79,0],[5530.35,11624.5,0],[7424.16,8112.4,0],[1559.47,4612.97,0],[6820.24,2741.86,0]];
...
_evac = [["I_G_Soldier_TL_F"],resistance,_pos,_target,40,20] call _GPF_fnc_rescueEvac; {[_x,false,false] execVM "gpf_randomgear.sqf";removeHeadgear _x;_x addHeadgear "Headgear_H_Beret_gen_F";} Foreach units _evac;
