...
if ((_plyr getVariable "GPF_EvacOn")) then {SystemChat Format ["no helicopters are available at this time! Please try again in a few mins."];} Else {
    openMap true;waitUntil {inputAction 'ActionInMap' > 0}; hint "Click on the map where you would like to go.";
    ...
    openMap false;
	hint "Evac is on route, please make your way to the landing zone.";
