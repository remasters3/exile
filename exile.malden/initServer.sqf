...
deathsqdon = false; publicVariable "deathsqdon";[] Spawn { while {true} Do {if ((count AllPlayers) > 0) Then {if (!deathsqdon) Then {sleep 30;[]execVM "gpf_troopdrop.sqf";};waitUntil {deathsqdon};};sleep 3600;};};
