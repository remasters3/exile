...
deathsqdon = false; publicVariable "deathsqdon";[] Spawn { while {true} Do {waituntil {((count AllPlayers) > 0)}; if (!deathsqdon) Then {[]execVM "gpf_troopdrop.sqf";};waitUntil {deathsqdon};sleep 3600;};};
