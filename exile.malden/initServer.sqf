...
deathsqdon = false; publicVariable "deathsqdon";dsVictim = nil;publicVariable "dsVictim";[] Spawn { while {true} Do {if (!deathsqdon) Then {sleep 30;[]execVM "gpf_troopdrop.sqf";};waitUntil {deathsqdon};sleep 3600;};};
