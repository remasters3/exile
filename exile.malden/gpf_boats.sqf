...
//if (_invert) Then {_Path = reverse _wps;} Else {_Path = _wps;};
...
_way setWaypointSpeed "NORMAL";
_way setWaypointCompletionRadius 50;
_way setWaypointStatements ["true", "_veh = Vehicle this; {deleteVehicle _x;} ForEach crew _veh; _veh setDamage 1;SeaPatrolon = SeaPatrolon-1; publicVariable 'SeaPatrolon';"];
