...
[_player] Spawn {_player = _this select 0;
  ...
  _GetInVehicle = {_unit = _this select 0; _veh = _this select 1;
	...
	if ((_veh emptyPositions "Gunner") > 0) Then {_unit assignAsGunner _veh;[_unit] orderGetIn true;};/*_unit moveInGunner _veh;*/
	if ((_veh emptyPositions "Commander") > 0) Then {_unit assignAsCommander _veh;[_unit] orderGetIn true;};/*_unit moveInCommander _veh;*/
	if ((_veh emptyPositions "Cargo") > 0) Then {_unit assignAsCargo _veh;[_unit] orderGetIn true;};/*_unit moveInCargo _veh;*/
	};
  };
