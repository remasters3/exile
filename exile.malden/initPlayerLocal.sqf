...
gpf_SpawnLandTransport = {
	...
	_quad Addaction ["Call Support (10000 tabs)",{[player] execVM 'gpf_player_support.sqf';}];
	_quad};
...
gpf_SpawnSeaTransport = {
	...
	_jetski Addaction ["Call Support (10000 tabs)",{[player] execVM 'gpf_player_support.sqf';}];
	_jetski};
